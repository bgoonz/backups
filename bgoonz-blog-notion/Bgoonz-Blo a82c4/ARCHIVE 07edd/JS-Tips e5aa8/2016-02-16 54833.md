# 2016-02-16-basics-declarations
...
```
var y,    x = (y = 1); //== var x; var y; x = y = 1console.log('--> 1:', `x = ${x}, y = ${y}`);// Will print//--> 1: x = 1, y = 1
```
...
```
x = 5; // == x = 5console.log('--> 5:', `x = ${x}, y = ${y}`);// Will print//--> 5: x = 5, y = 2
```

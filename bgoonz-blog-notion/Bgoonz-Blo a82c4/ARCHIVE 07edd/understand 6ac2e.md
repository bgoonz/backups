...
- **Application ID ("AppID")**: the unique identifier for the Firebase app across all of Firebase with a platform-specific format:
    - Firebase iOS apps: GOOGLE_APP_ID (example value: 1:1234567890:ios:321abc456def7890) This is *not* an Apple bundle ID.
...
![https://firebase.google.com/docs/projects/images/firebase_console_overview.png?authuser=0](https://firebase.google.com/docs/projects/images/firebase_console_overview.png?authuser=0)
